...
if (isset($_POST['BotonRegistrarOrdenCompra'])) {
    $Mensaje = Validar_Orden_Compra();
    if (empty($Mensaje)) {
        if (Insertar_Orden_Compra($MiConexion)) {
            $Mensaje = '¡Orden de compra registrada correctamente!';
            $_POST = array();
            $Estilo = 'success';
        } else {
            $Mensaje = 'Error: ' . ($GLOBALS['error_compra'] ?? 'Error desconocido');
            $Estilo = 'danger';
        }
    }
}
...
<main id="main" class="main">
    <section class="section">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Registrar Orden de Compra</h5>
                ...
                <form method="post">
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control precio" 
                                                       name="precio[]" step="0.01" min="0.01"
                                                       value="<?= $_POST['precio'][$index] ?? '' ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn btn-primario" name="BotonRegistrarOrdenCompra" value="1">
