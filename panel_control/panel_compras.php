          ...
          <div class="card-body">
            ...
            <div id="recomendacionesContainer">
              <div class="text-center py-4">
                ...
                <p class="text-muted mt-2">Haz clic en el botón para obtener recomendaciones basadas en tus datos de compras</p>
                <button id="btnObtenerRecomendaciones" class="btn btn-primary" onclick="obtenerRecomendacionesCompras()">
                  <i class="bi bi-magic"></i> Obtener Recomendaciones
                </button>
              </div>
              <div id="recomendacionesContent" class="d-none">
                <div class="d-flex justify-content-end mb-3">
                  <button class="btn btn-sm btn-outline-primary" onclick="obtenerRecomendacionesCompras()">
...
// Función para obtener recomendaciones de compras
async function obtenerRecomendacionesCompras() {
  ...
  let requestUrl = `../panel_control/get_recomendaciones_compras.php?periodo=${periodo}`;
  if (periodo === 'personalizado' && fechaInicio && fechaFin) {
